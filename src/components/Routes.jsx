...
import Formpay from '../pages/basket/component_checkout/Formpay';
import Formdirection from '../pages/basket/component_checkout/Formdirection';
...
export default function MainRoutes() {
    ...
    return (
        <Routes>
            ...
            <Route path='/para_empresas' element={
                <>
                    <NavBar />
                    <FooterEnd />
                </>
