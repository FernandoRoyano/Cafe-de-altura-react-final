        ...
        <div className="flex items-center justify-between text-left py-12 px-10 gap-6 ">
            <div className="flex items-start flex-col justify-center  gap-4">
                ...
                <div className="flex gap-4">
                    <Link className="text-white bg-black py-3 px-6 rounded-md" to={'/shop'} >Descubir orígenes</Link>
                    <Link className="text-white bg-strong-green py-3 px-6 rounded-md" to={'shop'} >Comprar café</Link>
                </div>
            </div>
            <div >
                <div >
